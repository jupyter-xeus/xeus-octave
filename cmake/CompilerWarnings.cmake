...
function(xeus_octave_target_add_compile_warnings target)
    option(XEUS_OCTAVE_WARNINGS_AS_ERRORS "Treat compiler warnings as errors" OFF)
    ...
    set(
        gcc_warnings
        ${clang_warnings}
        # FIXME currently not adding more warning for GCC because they fail on clang-tidy warn if
        # identation implies blocks where blocks do not exist -Wmisleading-indentation warn if if /
        # else chain has duplicated conditions -Wduplicated-cond warn if if / else branches have
        # duplicated code -Wduplicated-branches warn about logical operations being used where
        # bitwise were probably wanted -Wlogical-op warn if you perform a cast to the same type
        # -Wuseless-cast
    )
