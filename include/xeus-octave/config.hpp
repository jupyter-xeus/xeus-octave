...
#define XEUS_OCTAVE_VERSION_MINOR 1
...
#define XEUS_OCTAVE_VERSION XEUS_OCTAVE_STRINGIFY(XEUS_OCTAVE_CONCATENATE(XEUS_OCTAVE_VERSION_MAJOR,   \
                 XEUS_OCTAVE_CONCATENATE(.,XEUS_OCTAVE_CONCATENATE(XEUS_OCTAVE_VERSION_MINOR,   \
                                  XEUS_OCTAVE_CONCATENATE(.,XEUS_OCTAVE_VERSION_PATCH)))))
