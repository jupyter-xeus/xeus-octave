...
#ifndef XEUS_OCTAVE_XACCORDION_H
#define XEUS_OCTAVE_XACCORDION_H
...
template <typename D> struct widget<xw::xaccordion<D>>
{
  using W = xw::xaccordion<D>;

  static constexpr auto name = "xaccordion";
