...
#ifndef XEUS_OCTAVE_XPASSWORD_HPP
#define XEUS_OCTAVE_XPASSWORD_HPP

#include "xeus-octave/xwidgets.hpp"
#include "xeus-octave/xwidgets/xstring.hpp"
#include "xwidgets/xpassword.hpp"

namespace xeus_octave::widgets::xpassword {
...
inline void register_all(octave::interpreter& interpreter) {
	...
	octave::cdef_class cls = xwidgets_make_class<W>(interpreter, "xpassword");
