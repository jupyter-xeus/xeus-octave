...
#ifndef XEUS_OCTAVE_XPASSWORD_H
#define XEUS_OCTAVE_XPASSWORD_H
...
template <typename D> struct widget<xw::xpassword<D>>
{
  using W = xw::xpassword<D>;

  static constexpr auto name = "xpassword";
