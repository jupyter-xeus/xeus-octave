...
#ifndef XEUS_OCTAVE_XVIDEO_H
#define XEUS_OCTAVE_XVIDEO_H
...
template <typename D> struct widget<xw::xvideo<D>>
{
  using W = xw::xvideo<D>;

  static constexpr auto name = "xvideo";
  ...
  inline static void register_widget_members(octave::interpreter& interpreter, octave::cdef_class& cls)
  {
    ...
    static constexpr char const heifht_name[] = "Height";
    ...
    xwidgets_add_property<&W::height, heifht_name>(interpreter, cls);
