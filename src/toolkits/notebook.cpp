...
notebook_graphics_toolkit::notebook_graphics_toolkit(octave::interpreter& interpreter) :
...
void notebook_graphics_toolkit::finalize(octave::graphics_object const&) {}
...
void notebook_graphics_toolkit::redraw_figure(octave::graphics_object const& go) const {
#ifndef NDEBUG
  std::clog << "------------" << std::endl;
...
void notebook_graphics_toolkit::update(octave::graphics_object const&, int) {}
